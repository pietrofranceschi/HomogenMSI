...
#'
#' Images 1 to 5 belongs to scenario 1 where all images have a single gray level with different number of dark zones.
#' Images 2 to 4 are derived from image A by gradually adding dark zones/ drug inaccessibility areas.
#' Image A does not contains any dark-zones thus gives an accurate delineation of tumor morphology and used to
...
#' 2 and 4 gray levels, respectively. In last scenario IV, contains all images are similar to the one in scenario III
